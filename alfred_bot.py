...
# Dữ liệu món ăn (copy từ artifact trước)
# VIETNAMESE_FOODS = {...}  # Anh copy từ vietnamese_foods.py
VIETNAMESE_FOODS = {
    "phở": {
        "type": "nước",
        "category": "phở",
...
# REGIONAL_FOODS = {...}    # Anh copy từ regional_foods.py
REGIONAL_FOODS = {
